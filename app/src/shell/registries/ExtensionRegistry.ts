//! FILENAME: app/src/shell/registries/ExtensionRegistry.ts
// PURPOSE: Central registry for all extension points.
// CONTEXT: Add-ins register their contributions here; shell consumes them.
// NOTE: Moved from core/registry to shell/registries per microkernel architecture.
//       The Shell is responsible for extension hosting, not Core.
