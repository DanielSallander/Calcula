      ...
      return [
        ...
        dialogs,
        {
          ...
          methods: [
            ...
            { name: "onBeforePrint", signature: "onBeforePrint(handler)", description: "Called before printing or exporting to PDF; return false / { cancel: true, reason } to stop it" },
            { name: "onSheetChange", signature: "onSheetChange(handler)", description: "Called when active sheet changes" },
            { name: "onSheetAdd", signature: "onSheetAdd(handler)", description: "Called when a sheet is added ({ sheetIndex, sheetName, source })" },
            { name: "onSheetDelete", signature: "onSheetDelete(handler)", description: "Called when a sheet is deleted ({ sheetIndex, sheetName })" },
            { name: "onSheetRename", signature: "onSheetRename(handler)", description: "Called when a sheet is renamed ({ sheetIndex, oldName, newName })" },
      ...
      return [
        ...
        dialogs,
        {
          ...
          methods: [
            ...
            { name: "onBeforeDoubleClick", signature: "onBeforeDoubleClick(handler)", description: "Called before a double-click enters edit mode; return false / { cancel: true } to stop it" },
            { name: "onBeforeRightClick", signature: "onBeforeRightClick(handler)", description: "Called before the cell context menu opens; return false / { cancel: true } to suppress it" },
          ],
        },
        {
          category: "Data",
