...
export const CHART_EXAMPLES: ChartExample[] = [
  ...
  {
    id: "stepper-threshold",
    name: "Stepper control",
    description: "A +/- stepper (shown at top-left when the chart is selected) sets a Threshold the chart filters by. Bound widgets make params interactively adjustable on the canvas.",
    category: "Interactivity",
    spec: {
      mark: "bar",
      data: RANGE,
      ...
      legend: { visible: false, position: "bottom" },
      palette: "default",
      params: [{ name: "Threshold", value: 100, bind: { input: "stepper", min: 0, max: 1000, step: 50 } }],
      transform: [{ type: "filter", field: "Revenue", predicate: "value > [Threshold]" }],
    },
  },
  {
    id: "brush-select",
    name: "Brush to highlight",
    description: "Drag a rectangle over the bars to highlight the covered set (brush:true); a plain click selects one. Conditional color dims the rest.",
    category: "Interactivity",
    spec: {
      mark: "bar",
      data: RANGE,
      ...
      series: [{
        ...
        sourceIndex: 1,
        color: null,
        encoding: { color: { condition: { field: "category", inSelection: "brushed" }, value: "#4E79A7", otherwise: "#d6d6d6" } },
      }],
