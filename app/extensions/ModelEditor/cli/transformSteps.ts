...
export const TRANSFORM_STEP_OPTIONS: CliOptionSpec[] = [
  ...
  { key: "dataType", type: "enum", values: [...DATA_TYPE_NAMES], help: "addColumn: declared type; omit to infer" },
  { key: "column", type: "string", help: "single column: splitColumn replaceValues" },
