//! FILENAME: app/extensions/FormulaVisualizer/lib/treeLayoutEngine.ts
// PURPOSE: Pure tree layout computation, extracted from useTreeLayout for testability.
...
export function estimateNodeWidth(node: EvalPlanNode): number {
