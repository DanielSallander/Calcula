//! FILENAME: app/extensions/_shared/components/DropZone.tsx
...
export function DropZone({
  ...
  const placeholder = customPlaceholder ?? getDefaultPlaceholder(zone);
...
function getDefaultPlaceholder(zone: DropZoneType): string {
  switch (zone) {
    case 'filters':
