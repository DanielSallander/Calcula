...
pub fn get_functions_by_category(category: String) -> FunctionListResult {
    ...
    let functions = match category.to_lowercase().as_str() {
        "autosum" | "math" => vec![
            ...
            FunctionInfo {
                name: "SUMX2MY2".to_string(),
                syntax: "SUMX2MY2(array_x, array_y)".to_string(),
                description: "Returns the sum of the difference of squares of corresponding values".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SUMX2PY2".to_string(),
                syntax: "SUMX2PY2(array_x, array_y)".to_string(),
                description: "Returns the sum of the sum of squares of corresponding values".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SUMXMY2".to_string(),
                syntax: "SUMXMY2(array_x, array_y)".to_string(),
                description: "Returns the sum of squares of differences of corresponding values".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
            ...
            FunctionInfo {
                ...
                syntax: "MROUND(number, multiple)".to_string(),
                description: "Rounds a number to the nearest multiple".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "QUOTIENT".to_string(),
                syntax: "QUOTIENT(numerator, denominator)".to_string(),
                description: "Returns the integer portion of a division".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SUMSQ".to_string(),
                syntax: "SUMSQ(number1, [number2], ...)".to_string(),
                description: "Returns the sum of the squares of the arguments".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "ROMAN".to_string(),
                syntax: "ROMAN(number, [form])".to_string(),
                description: "Converts an Arabic numeral to Roman numeral text".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "ARABIC".to_string(),
                syntax: "ARABIC(text)".to_string(),
                description: "Converts a Roman numeral text to an Arabic numeral".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "BASE".to_string(),
                syntax: "BASE(number, radix, [min_length])".to_string(),
                description: "Converts a number into a text representation with the given radix".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "DECIMAL".to_string(),
                syntax: "DECIMAL(text, radix)".to_string(),
                description: "Converts a text representation of a number in a given base to decimal".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SINH".to_string(),
                syntax: "SINH(number)".to_string(),
                description: "Returns the hyperbolic sine of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "COSH".to_string(),
                syntax: "COSH(number)".to_string(),
                description: "Returns the hyperbolic cosine of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "TANH".to_string(),
                syntax: "TANH(number)".to_string(),
                description: "Returns the hyperbolic tangent of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "COT".to_string(),
                syntax: "COT(number)".to_string(),
                description: "Returns the cotangent of an angle".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "COTH".to_string(),
                syntax: "COTH(number)".to_string(),
                description: "Returns the hyperbolic cotangent of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "CSC".to_string(),
                syntax: "CSC(number)".to_string(),
                description: "Returns the cosecant of an angle".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "CSCH".to_string(),
                syntax: "CSCH(number)".to_string(),
                description: "Returns the hyperbolic cosecant of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SEC".to_string(),
                syntax: "SEC(number)".to_string(),
                description: "Returns the secant of an angle".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SECH".to_string(),
                syntax: "SECH(number)".to_string(),
                description: "Returns the hyperbolic secant of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "ACOT".to_string(),
                syntax: "ACOT(number)".to_string(),
                description: "Returns the arccotangent of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "CEILING.MATH".to_string(),
                syntax: "CEILING.MATH(number, [significance], [mode])".to_string(),
                description: "Rounds a number up to the nearest integer or nearest multiple of significance".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "CEILING.PRECISE".to_string(),
                syntax: "CEILING.PRECISE(number, [significance])".to_string(),
                description: "Rounds a number up to the nearest integer or nearest multiple of significance".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "FLOOR.MATH".to_string(),
                syntax: "FLOOR.MATH(number, [significance], [mode])".to_string(),
                description: "Rounds a number down to the nearest integer or nearest multiple of significance".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "FLOOR.PRECISE".to_string(),
                syntax: "FLOOR.PRECISE(number, [significance])".to_string(),
                description: "Rounds a number down to the nearest integer or nearest multiple of significance".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "ISO.CEILING".to_string(),
                syntax: "ISO.CEILING(number, [significance])".to_string(),
                description: "Rounds a number up to the nearest integer or nearest multiple of significance".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "MULTINOMIAL".to_string(),
                syntax: "MULTINOMIAL(number1, [number2], ...)".to_string(),
                description: "Returns the multinomial of a set of numbers".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "COMBINA".to_string(),
                syntax: "COMBINA(number, number_chosen)".to_string(),
                description: "Returns the number of combinations with repetitions".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "FACTDOUBLE".to_string(),
                syntax: "FACTDOUBLE(number)".to_string(),
                description: "Returns the double factorial of a number".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "SQRTPI".to_string(),
                syntax: "SQRTPI(number)".to_string(),
                description: "Returns the square root of (number * pi)".to_string(),
                category: "Math".to_string(),
            },
            FunctionInfo {
                name: "AGGREGATE".to_string(),
                syntax: "AGGREGATE(function_num, options, ref1, ...)".to_string(),
                description: "Returns an aggregate in a list or database, with options to ignore errors and hidden rows".to_string(),
                category: "Math".to_string(),
            },
        ],
        "logical" => vec![
        ...
        "text" => vec![
            ...
            FunctionInfo {
                ...
                syntax: "DOLLAR(number, [decimals])".to_string(),
                description: "Converts a number to text using currency format".to_string(),
                category: "Text".to_string(),
            },
            FunctionInfo {
                name: "EURO".to_string(),
                syntax: "EURO(number, [decimals])".to_string(),
                description: "Converts a number to text using euro currency format".to_string(),
                category: "Text".to_string(),
            },
            FunctionInfo {
                name: "FIXED".to_string(),
                syntax: "FIXED(number, [decimals], [no_commas])".to_string(),
                description: "Formats a number as text with a fixed number of decimals".to_string(),
                category: "Text".to_string(),
            },
            FunctionInfo {
                name: "UNICHAR".to_string(),
                syntax: "UNICHAR(number)".to_string(),
                description: "Returns the Unicode character for a given number".to_string(),
                category: "Text".to_string(),
            },
            FunctionInfo {
                name: "UNICODE".to_string(),
                syntax: "UNICODE(text)".to_string(),
                description: "Returns the Unicode code point for the first character of text".to_string(),
                category: "Text".to_string(),
            },
            FunctionInfo {
                name: "ENCODEURL".to_string(),
                syntax: "ENCODEURL(text)".to_string(),
                description: "Returns a URL-encoded string".to_string(),
                category: "Text".to_string(),
            },
        ],
        "lookup" | "lookup & reference" => vec![
            ...
            FunctionInfo {
                ...
                syntax: "VLOOKUP(lookup_value, table_array, col_index_num, [range_lookup])".to_string(),
                description: "Looks up a value in the first column of a table and returns a value in the same row".to_string(),
                category: "Lookup & Reference".to_string(),
            },
            FunctionInfo {
                name: "HLOOKUP".to_string(),
                syntax: "HLOOKUP(lookup_value, table_array, row_index_num, [range_lookup])".to_string(),
                description: "Looks up a value in the first row of a table and returns a value in the same column".to_string(),
                category: "Lookup & Reference".to_string(),
            },
            FunctionInfo {
                name: "LOOKUP".to_string(),
                syntax: "LOOKUP(lookup_value, lookup_vector, [result_vector])".to_string(),
                description: "Looks up a value in a one-row or one-column range".to_string(),
                category: "Lookup & Reference".to_string(),
            },
        ],
        "info" | "information" => vec![
            ...
            FunctionInfo {
                ...
                syntax: "ERROR.TYPE(error_val)".to_string(),
                description: "Returns a number corresponding to the error type".to_string(),
                category: "Information".to_string(),
            },
            FunctionInfo {
                name: "ISNONTEXT".to_string(),
                syntax: "ISNONTEXT(value)".to_string(),
                description: "Returns TRUE if the value is not text".to_string(),
                category: "Information".to_string(),
            },
            FunctionInfo {
                name: "ISREF".to_string(),
                syntax: "ISREF(value)".to_string(),
                description: "Returns TRUE if the value is a reference".to_string(),
                category: "Information".to_string(),
            },
            FunctionInfo {
                name: "SHEET".to_string(),
                syntax: "SHEET([value])".to_string(),
                description: "Returns the sheet number of the referenced sheet".to_string(),
                category: "Information".to_string(),
            },
            FunctionInfo {
                name: "SHEETS".to_string(),
                syntax: "SHEETS([reference])".to_string(),
                description: "Returns the number of sheets in a reference or workbook".to_string(),
                category: "Information".to_string(),
            },
        ],
        "date" | "date & time" => vec![
            ...
            FunctionInfo {
                name: "DAYS".to_string(),
                syntax: "DAYS(end_date, start_date)".to_string(),
                description: "Returns the number of days between two dates".to_string(),
                category: "Date & Time".to_string(),
            },
            FunctionInfo {
                name: "TIME".to_string(),
                syntax: "TIME(hour, minute, second)".to_string(),
                description: "Returns a time value from hour, minute, and second components".to_string(),
                category: "Date & Time".to_string(),
            },
        ],
        "statistical" => vec![
