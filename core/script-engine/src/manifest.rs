...
pub const OP_MANIFEST: &[OpEntry] = &[
    ...
    op("Calcula.getDisplayFormulas", ReachClass::View),
    ...
    op("Calcula.getRangeEdge", ReachClass::Grid),
    ...
    op("Calcula.setDisplayFormulas", ReachClass::View),
    ...
    // Calcula.text.* is PURE COMPUTE (string in, string/rows out): it touches
    // neither the cloned grid nor anything outside the realm. There is no
    // "nothing" class, so it is classified at the innermost floor (Grid),
    // which never widens any surface's reach claim.
    op("Calcula.text", ReachClass::Grid),
    op("Calcula.text.parseCsv", ReachClass::Grid),
    op("Calcula.text.toCsv", ReachClass::Grid),
    ...
    op("Range.boundingUnion", ReachClass::Grid),
    op("Range.cells", ReachClass::Grid),
    op("Range.colCount", ReachClass::Grid),
    op("Range.columns", ReachClass::Grid),
    op("Range.contains", ReachClass::Grid),
    op("Range.end", ReachClass::Grid),
    op("Range.endCol", ReachClass::Grid),
    op("Range.endRow", ReachClass::Grid),
    op("Range.entireColumn", ReachClass::Grid),
    op("Range.entireRow", ReachClass::Grid),
    op("Range.getCell", ReachClass::Grid),
    op("Range.intersect", ReachClass::Grid),
