...
//! PURPOSE: Connection helpers for live .calp applications.
...
/// Build the SSPI connection string from application-level server/database hints.
...
/// Read the embedded DataModel JSON from the workspace.
