  ...
  kpis: [
    {
      ...
      description:
        "Margin percent against a 35% goal. The band STATUSES run OffTrack -> AtRisk -> OnTrack " +
        "as the base/target ratio grows, which is what makes this measure higher-is-better. " +
        "(The thresholds ascend too, but the engine forces that on every KPI, so threshold " +
        "order says nothing — an earlier version of this fixture claimed it did.)",
    },
  ],
};
