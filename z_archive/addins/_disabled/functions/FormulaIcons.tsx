...
export function FinancialIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <ellipse cx="9" cy="17" rx="6" ry="3" fill="none" stroke="#5b9a4b" strokeWidth="1.5" />
      <ellipse cx="9" cy="14" rx="6" ry="3" fill="none" stroke="#5b9a4b" strokeWidth="1.5" />
      <ellipse cx="9" cy="11" rx="6" ry="3" fill="none" stroke="#5b9a4b" strokeWidth="1.5" />
...
export function LogicalIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <rect x="4" y="4" width="16" height="16" rx="2" fill="none" stroke="#9966cc" strokeWidth="1.5" />
      <text
        x="12"
        y="17"
        fontSize="14"
...
export function TextIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <rect x="4" y="4" width="16" height="16" rx="2" fill="none" stroke="#c44" strokeWidth="1.5" />
      <text
        x="12"
        y="17"
        fontSize="14"
...
export function DateTimeIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <circle cx="12" cy="12" r="8" fill="none" stroke="#cc6633" strokeWidth="1.5" />
      <path d="M12 7v5l3 3" stroke="#cc6633" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function LookupIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <circle cx="10" cy="10" r="6" fill="none" stroke="#3399cc" strokeWidth="1.5" />
      <path d="M14.5 14.5L20 20" stroke="#3399cc" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function MathTrigIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <rect x="4" y="4" width="16" height="16" rx="2" fill="none" stroke="#339966" strokeWidth="1.5" />
      <text
        x="12"
        y="17"
        fontSize="13"
...
export function MoreFunctionsIcon(): React.ReactElement {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24">
      <rect x="4" y="4" width="16" height="16" rx="2" fill="none" stroke="#993333" strokeWidth="1.5" />
